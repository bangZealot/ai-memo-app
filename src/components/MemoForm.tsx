...
export default function MemoForm({
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4 z-50">
      <div
        className={`bg-white rounded-lg shadow-xl w-full max-h-[90vh] overflow-y-auto transition-all duration-300 ${
        ...
        <div className="p-6">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="grid grid-cols-2 gap-3">
                  ...
                  <div className="flex flex-col">
                    ...
                    <textarea
                      ...
                      className="placeholder-gray-400 text-gray-700 w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors resize-none flex-1 font-mono text-sm"
            ...
            <div className="flex gap-3">
              ...
              >
                {submitting ? '저장 중...' : editingMemo ? '수정하기' : '저장하기'}
              </button>
            </div>
          </form>
        </div>
